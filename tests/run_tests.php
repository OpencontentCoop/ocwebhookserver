...
$testFiles = [
    ...
    __DIR__ . '/PayloadFormatterNestedRelationTest.php',
    __DIR__ . '/EmitAllPublishedContentUrlTest.php',
    __DIR__ . '/EmitterOutboxTest.php',
    __DIR__ . '/PayloadBuilderTest.php',
    __DIR__ . '/PayloadBuilderNestedRelationTest.php',
    __DIR__ . '/PayloadBuilderLanguageOrderTest.php',
    __DIR__ . '/PayloadBuilderForceHttpsTest.php',
    __DIR__ . '/PayloadFormatterForceHttpsTest.php',
