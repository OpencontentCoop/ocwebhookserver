                ...
                <table class="table table-sm">
                    ...
                    {foreach $jobs as $job}
                        <tr class="{if $job.execution_status|eq(2)}table-success{elseif $job.execution_status|eq(3)}table-danger{elseif $job.execution_status|eq(1)}table-warning{elseif $job.execution_status|eq(4)}table-info{/if}">
                            ...
                            <td class="align-middle">
                                <button type="button" class="btn btn-secondary btn-xs" data-toggle="modal" data-target="#payloadModal-{$job.id}">
                                    Show payload
                                </button>
                            ...
                            <td class="align-middle">
                                ...
                                <button type="button" class="btn btn-secondary btn-xs" data-toggle="modal" data-target="#responseModal-{$job.id}">
                                    Show response
                                </button>
